...
cneg_rt_Generic(UQV, Goal, Proposal) :-
	...
	!, % Reduce the stack's memory by forbidding backtracking.
	echo_msg(2, 'cneg_rt_Chan', 'list', 'cneg_rt_Generic :: List_Of_Disj_Result', List_Of_Disj_Result),
...
cneg_rt_Aux(UQV_In, Goal, Proposal, Trace, Result) :-
	echo_msg(2, 'cneg_rt_Chan', 'separation', '', ''),
	echo_msg(2, 'cneg_rt_Chan', 'nl', '', ''),
	...
	echo_msg(2, 'cneg_rt_Chan', 'nl', '', ''),
	echo_msg(2, 'cneg_rt_Chan', 'statistics', '', (cneg_rt_Aux(UQV_In, Goal, Proposal, Trace))),
	echo_msg(2, 'cneg_rt_Chan', 'nl', '', ''),
	...
	echo_msg(2, 'cneg_rt_Chan', 'list', 'cneg_rt_Aux :: Frontier', Frontier),
...
compute_set_of_frontiers(Goal, Proposal, Trace, UQV, Frontier, New_UQV) :-
	...
	echo_msg(2, 'cneg_rt_Chan', 'list', 'compute_set_of_frontiers :: Goals', Goals),
...
%	echo_msg(2, 'cneg_rt_Chan', 'list', 'compute_set_of_frontiers_aux :: Frontier_Aux', Frontier_Aux),
...
compute_goal_frontier(Goal, _Proposal, _Trace, _Frontier_Out):- 
	...
	echo_msg(2, 'cneg_rt_Chan', 'nl', '', ''), !, % Backtracking is forbidden.
	fail.
...
compute_goal_frontier(Goal, Proposal, Trace, Frontier) :- 
	...
	echo_msg(2, 'cneg_rt_Chan', 'list', 'compute_goal_frontier :: dn :: List_Of_Conjs_Frontier', List_Of_Conjs_Frontier),
	build_a_frontier_from_each_result(Goal, List_Of_Conjs_Frontier, Frontier),
	echo_msg(2, 'cneg_rt_Chan', 'list', 'double neg :: Frontier', Frontier),
	echo_msg(2, 'cneg_rt_Chan', 'separation', '', ''),
	echo_msg(2, 'cneg_rt_Chan', 'nl', '', '').
...
%	echo_msg(2, 'cneg_rt_Chan', 'list', 'Frontier_Tmp_1', Frontier_Tmp_1),
