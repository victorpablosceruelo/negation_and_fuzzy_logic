...
cneg_rt_Stuckey(UQV, Goal):-
	echo_msg(1, 'cneg_rt :: (UQV, Goal)', (UQV, Goal)),
...
compute_neg_frontier(Goal, GoalVars, Prev_Front_Residua) :-
	echo_msg(1, '--------------------------------------------------------------------------------------------------------------', ' '),
	echo_msg(1, 'compute_neg_frontier :: (Goal, GoalVars, Prev_Front_Residua)', (Goal, GoalVars, Prev_Front_Residua)),	
...
compute_neg_frontier(Goal, GoalVars, Prev_Front_Residua):- 
	...
	echo_msg(1, 'compute_neg_frontier :: Prev_Front_Residua', Prev_Front_Residua),	
...
compute_neg_frontier(Goal, GoalVars, 'true'):- 
	...
	echo_msg(1, 'compute_neg_frontier :: disj :: negate G1', ' '),
	compute_neg_frontier(G1, GoalVars, 'true'),
	echo_msg(1, 'compute_neg_frontier :: disj :: negate G2', ' '),
...
compute_neg_frontier(Goal, GoalVars, 'true'):- 
	...
	(
	    (
		echo_msg(1, 'compute_neg_frontier :: conj :: negate G1', ' '),
		compute_neg_frontier(G1, GoalVars, 'true')
	    )
	;
	    (
		echo_msg(1, '--------------------------------------------------------------------------------------------------------------', ' '),
		echo_msg(1, 'compute_neg_frontier :: conj :: assume G1, negate G2', ' '),
...
compute_neg_frontier(Goal, GoalVars, 'true') :-
	...
	echo_msg(1, 'compute_neg_frontier :: Goal', Goal),
	look_for_the_relevant_clauses(Goal, Frontier_Tmp_1),
	echo_msg(1, 'compute_neg_frontier :: format', '(Head, Body, FrontierTest)'),
	echo_msg_list(1, 'Frontier_Tmp_1', Frontier_Tmp_1),
	simplify_frontier(Frontier_Tmp_1, Goal, Frontier_Tmp_2),
	echo_msg(1, 'Frontier_Tmp_2', Frontier_Tmp_2), 
	combine_frontiers_by_disjunction(Frontier_Tmp_2, 'fail', Frontier_Tmp_3),
	echo_msg(1, 'Frontier_Tmp_3', Frontier_Tmp_3), 
...
compute_neg_frontier(Goal, GoalVars, Prev_Front_Residua) :-
	echo_msg(1, 'ERROR: compute_neg_frontier :: (Goal, GoalVars, Prev_Front_Residua)', (Goal, GoalVars, Prev_Front_Residua)), 
	nl, !, fail.
...
test_frontier_is_valid(Goal, Head, Frontier_Test) :-
	echo_msg(1, 'test_frontier_is_valid :: (Head, FrontierTest, Goal)', (Head, Frontier_Test, Goal)),
...
%	echo_msg(1, 'test_frontier_is_valid', 'YES'),
...
evaluate_prev_frontier_residua(Goal, GoalVars_In, Prev_Front_Residua) :-
	echo_msg(1, 'evaluate_prev_frontier_residua :: Prev_Front_Residua', Prev_Front_Residua),	
	Prev_Front_Residua \== 'true',

	varsbag(GoalVars_In, [], [], GoalVars),
	varsbag((Goal, Prev_Front_Residua), GoalVars, [], LocalVars),
	echo_msg(1, 'evaluate_prev_frontier_residua :: GoalVars_In', GoalVars_In),
	...
	echo_msg(1, 'evaluate_prev_frontier_residua :: Pre_F_Sols', Pre_F_Sols),
	echo_msg_nl(1),
...
take_and_compute_one_solution(Real_GoalVars, [Pre_F_Sol | Pre_F_Sols]) :-
	(
	    ...
	    echo_msg(1, 'take_one_solution :: Local_Stuff ', Local_Stuff),
...
unify_pre_sols_when_possible(To_Unify, After_Unified) :- 
	echo_msg_list(1, 'evaluate_prev_frontier_residua :: To_Unify', To_Unify),
	unify_sols_when_possible_aux_1(To_Unify, [], Unified, [], Not_Unified), !,
	(
	    (
		Unified == [], 
		echo_msg(1, 'evaluate_prev_frontier_residua :: Not_Unified', Not_Unified),
	...
	;
		...
		echo_msg_list(1, 'evaluate_prev_frontier_residua :: New_To_Unify', New_To_Unify),
