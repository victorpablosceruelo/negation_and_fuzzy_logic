...
yes
?- no_attack_down(s(s(0)),s(0),s(0)).

no
?- no_attack1([s(s(0))],s(0),s(0)).
...
attach_attribute(X,formula(X,[[X/s(fA(_A)),X/s(0)]])),
attach_attribute(_A,formula(_A,[[X/s(fA(_A)),_A/0]])) ? ;
