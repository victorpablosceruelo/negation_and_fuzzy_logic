...
negate_conj(C,G,GoalVars,SolC) :-
        ...
        'negate_conj/4/1/$disj/1'(GoalVars,SolC,I,D,R).
...
generar_ih([A1|Ra],[Var|RVar],[A1=Var|Ri]) :-
        generar_ih(Ra,RVar,Ri).

organization_conj((Head,BodyList),G,_GoalVars,I,D,R) :-
        G=..[_Term|ArgsG],
        varset_order(Head,HeadVarsAux),
        reverse(HeadVarsAux,HeadVars),
        generar_ih(ArgsG,HeadVars,Ih),
...
organization_body([dist(T1,T2)|BodyList],I,[dist(T1,T2)|D],R) :-
        ...
        !,
        'organization_body/4/4/$disj/1'(I,R,BodyList,D,VarsI,VarsNew,Vars,Values).
...
normalization_conj(I,D,R,GoalVars,I1,D1,ImpVars,ExpVars) :-
        varset(R,RVars),
        difference(RVars,GoalVars,RelVars1),
        varset(I,IVars),
        union(IVars,GoalVars,ImpVars1),
        remove_duplicates(ImpVars1,ImpVars),
        difference(RVars,ImpVars,ExpVars1),
        eliminate_redundant_var(I,GoalVars,Iv),
        eliminate_repeated_eq(Iv,I1),
        remove_duplicates(ExpVars1,ExpVars),
        remove_duplicates(RelVars1,RelVars),
        eliminate_irrelevant_disequalities(D,ImpVars,RelVars,D1).

unificar([],_GV).

unificar([V1=V2|RestoI],GV) :-
        ground(V1),
        ground(V2),
        !,
        unificar(RestoI,GV).
...
start_of_file('/home/susana/tesis/micodigo/cneg/antonio/proof_cneg').
...
stored_clause(start_of_file(_1),[_1='/home/susana/tesis/micodigo/cneg/antonio/proof_cneg']).

stored_clause(odd(_1),[_1=s(0)]).

stored_clause(odd(_1),[_1=s(s(_2)),odd(_2)]).

stored_clause(not_odd_number(_1),[_1=_2,cneg(odd(_2))]).

stored_clause(parent(_1,_2),[_1=a1,_2=p]).

stored_clause(parent(_1,_2),[_1=a2,_2=p]).

stored_clause(parent(_1,_2),[_1=p,_2=h1]).

stored_clause(parent(_1,_2),[_1=p,_2=h2]).

stored_clause(grandparent(_1,_2),[_1=_3,_2=_4,parent(_3,_5),parent(_5,_4)]).

stored_clause(boole(_1),[_1=0]).

stored_clause(boole(_1),[_1=1]).

stored_clause(binary_list(_1),[_1=[]]).

stored_clause(binary_list(_1),[_1=[_2|_3],boole(_2),binary_list(_3)]).

stored_clause(dist_list(_1),[_1=[]]).

stored_clause(dist_list(_1),[_1=[(_3,_4)|_2],dist(_3,_4),dist_list(_2)]).

stored_clause(p(_1,_2,_3,_4),[_1=1,_2=2,_3=_5,_4=_5,dist(_5,3),dist(_5,_6),q(_6)]).

stored_clause(p1(_1),[_1=_2,dist(_2,3),dist(_2,_3),q(_3)]).

stored_clause(p2(_1),[_1=_2,dist(_2,3),dist(_2,_3)]).

stored_clause(p3(_1),[_1=_2,dist(_2,3),dist(_2,5)]).

stored_clause(p4(_1,_2),[_1=_3,_2=_4,dist(_3,3),dist(_4,5)]).

stored_clause(q(_1),[_1=_2,dist(_2,0)]).

stored_clause(q(_1),[_1=_2,r(_2,_3)]).

stored_clause(r(_1,_2),[_1=8,_2=9]).

stored_clause(positive(_1),[_1=0]).

stored_clause(positive(_1),[_1=s(_2),positive(_2)]).

stored_clause(natural(_1),[_1=_2,dist(_2,0),positive(_2)]).

stored_clause(pred2(_1,_2),[_1=7,_2=_3]).

stored_clause(pred2(_1,_2),[_1=9,_2=_3,dist(_3,5),pred1(_4)]).

stored_clause(pred1(_1),[_1=2]).

stored_clause(iguales(_1,_2),[_1=_3,_2=_3]).

stored_clause(r1(_1,_2),[_1=1,_2=1]).

stored_clause(r1(_1,_2),[_1=2,_2=2]).

stored_clause(r2(_1,_2),[_1=_3,_2=_4,r(_3,_4)]).

stored_clause(r3(_1,_2),[_1=1,_2=2]).

stored_clause(r3(_1,_2),[_1=2,_2=3]).

stored_clause(r4(_1,_2),[_1=_3,_2=_4,r3(_3,_5),r3(_5,_4)]).

stored_clause(r5(_1,_2,_3),[_1=_4,_2=_5,_3=_6,r3(_4,_5),r3(_5,_6)]).

stored_clause(no_boole(_1),[_1=_2,cneg(boole(_2))]).

stored_clause(no_binary_list(_1),[_1=_2,cneg(binary_list(_2))]).

stored_clause(no_dist_list(_1),[_1=_2,cneg(dist_list(_2))]).

stored_clause(no_p(_1,_2,_3,_4),[_1=_5,_2=_6,_3=_7,_4=_8,cneg(p(_5,_6,_7,_8))]).

stored_clause(no_q(_1),[_1=_2,cneg(q(_2))]).

stored_clause(no_r(_1,_2),[_1=_3,_2=_4,cneg(r(_3,_4))]).

stored_clause(no_p1(_1),[_1=_2,cneg(p1(_2))]).

stored_clause(no_p2(_1),[_1=_2,cneg(p2(_2))]).

stored_clause(no_p3(_1),[_1=_2,cneg(p3(_2))]).

stored_clause(no_p4(_1,_2),[_1=_3,_2=_4,cneg(p4(_3,_4))]).

stored_clause(no_positive(_1),[_1=_2,cneg(positive(_2))]).

stored_clause(no_natural(_1),[_1=_2,cneg(natural(_2))]).

stored_clause(no_parent(_1,_2),[_1=_3,_2=_4,cneg(parent(_3,_4))]).

stored_clause(no_grandparent(_1,_2),[_1=_3,_2=_4,cneg(grandparent(_3,_4))]).

stored_clause(no_pred2(_1,_2),[_1=_3,_2=_4,cneg(pred2(_3,_4))]).

stored_clause(no_pred1(_1),[_1=_2,cneg(pred1(_2))]).

stored_clause(no_iguales(_1,_2),[_1=_3,_2=_4,cneg(iguales(_3,_4))]).

stored_clause(no_r1(_1,_2),[_1=_3,_2=_4,cneg(r1(_3,_4))]).

stored_clause(no_r2(_1,_2),[_1=_3,_2=_4,cneg(r2(_3,_4))]).

stored_clause(no_r3(_1,_2),[_1=_3,_2=_4,cneg(r3(_3,_4))]).

stored_clause(no_r4(_1,_2),[_1=_3,_2=_4,cneg(r4(_3,_4))]).

stored_clause(no_r5(_1,_2,_3),[_1=_4,_2=_5,_3=_6,cneg(r5(_4,_5,_6))]).
