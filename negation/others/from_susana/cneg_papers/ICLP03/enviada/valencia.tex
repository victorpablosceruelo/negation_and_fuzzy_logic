%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% INTENSIONAL NEGATION. WFLP 2003
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
are hard to be managed. On the other hand the operational behavior of
...
we conclude and discuss some future work (Section \ref{strategy}). Due
to space limitations we do not provide details of the proofs, that
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Toward a Better Transformation}
...
\item Replace $\neg C$ by its \emph{negated normal form} $\NNF(\neg
      C)$ \footnote{The \emph{negated normal form} of $C$, is
