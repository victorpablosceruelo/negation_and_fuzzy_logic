...
(negation as failure, stable models, well founded semantics, explicit
...
needed, optimizations (Section \ref{optimization}) and some examples
(Section \ref{examples}). Finally we conclude and talk about future
works in Section \ref{conclusion}.
...
On the other hand we have cut the search tree of the generation of the
