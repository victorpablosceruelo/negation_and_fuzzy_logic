...
attach_attribute(X,formula(X,[[X/9]])) ? ;

attach_attribute(Y,formula(Y,[[Y/8]])) ? ;
...
attach_attribute(Qs,formula(Qs,[[Qs/[s(0),s(s(0))],Qs/[s(s(0)),s(0)]]])) ? ;
...
attach_attribute(Qs,formula(Qs,[[Qs/[s(k)]]])) ? ;
