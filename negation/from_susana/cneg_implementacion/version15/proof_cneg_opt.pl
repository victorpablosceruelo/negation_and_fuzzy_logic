...
stored_clause(stored_clause(odd(s(0)),[]),[]).

stored_clause(stored_clause(odd(s(s(_1))),[odd(_1)]),[]).
...
stored_pred(stored_clause(_1,_2),stored_clause(_1,_2)).
