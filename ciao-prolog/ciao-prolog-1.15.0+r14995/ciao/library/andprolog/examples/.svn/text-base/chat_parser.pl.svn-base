...
main_nondet_par(N) :-
	...
	floor(SpUp,Sp1),
	Sp is Sp1/100,
	format("-- chat_parser, ~d agents, SpeedUp=~2f TPar=~f~n",[N,Sp,P]),
	fail.
...
main(_) :-
	...
	chat_par,
        statistics(walltime, [T2,_]),
        Delta is T2 - T1,
	format("-- chat_parser=~f ms.~n", [Delta]),
	fail.
main(_).
...
% chat_parser :- many_sentences(X),
%                determinate_say(X,_Said),
% % 	       display('-----------------------------'), nl,
% %              display(Said), nl,
% % 	       display('-----------------------------'), nl,
%                fail.
...
sentence([what,rivers,are,there,?]).
sentence([does,afghanistan,border,china,?]).
sentence([what,is,the,capital,of,upper_volta,?]).
sentence([where,is,the,largest,country,?]).
sentence([which,country,'`',s,capital,is,london,?]).
sentence([which,countries,are,european,?]).
sentence([how,large,is,the,smallest,american,country,?]).
sentence([what,is,the,ocean,that,borders,african,countries,
	  and,that,borders,asian,countries,?]).
sentence([what,are,the,capitals,of,the,countries,bordering,the,baltic,?]).
sentence([which,countries,are,bordered,by,two,seas,?]).
sentence([how,many,countries,does,the,danube,flow,through,?]).
sentence([what,is,the,total,area,of,countries,south,of,the,equator,
	  and,not,in,australasia,?]).
sentence([what,is,the,average,area,of,the,countries,in,each,continent,?]).
sentence([is,there,more,than,one,country,in,each,continent,?]).
sentence([is,there,some,ocean,that,does,not,border,any,country,?]).
sentence([what,are,the,countries,from,which,a,river,flows,
	  into,the,black_sea,?]).

sentence1([what,rivers,are,there,?]).
sentence1([does,afghanistan,border,china,?]).
sentence1([what,is,the,capital,of,upper_volta,?]).
sentence1([where,is,the,largest,country,?]).
sentence1([which,country,'`',s,capital,is,london,?]).
sentence1([which,countries,are,european,?]).
sentence1([how,large,is,the,smallest,american,country,?]).
sentence1([what,is,the,ocean,that,borders,african,countries,
	and,that,borders,asian,countries,?]).

sentence2([what,are,the,capitals,of,the,countries,bordering,the,baltic,?]).
sentence2([which,countries,are,bordered,by,two,seas,?]).
sentence2([how,many,countries,does,the,danube,flow,through,?]).
sentence2([what,is,the,total,area,of,countries,south,of,the,equator,
	and,not,in,australasia,?]).
sentence2([what,is,the,average,area,of,the,countries,in,each,continent,?]).
sentence2([is,there,more,than,one,country,in,each,continent,?]).
sentence2([is,there,some,ocean,that,does,not,border,any,country,?]).
sentence2([what,are,the,countries,from,which,a,river,flows,
	into,the,black_sea,?]).
