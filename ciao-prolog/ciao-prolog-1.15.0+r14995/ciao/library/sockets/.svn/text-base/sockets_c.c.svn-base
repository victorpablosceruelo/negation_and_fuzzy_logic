...
stream_node_t *new_socket_stream(streamname, socket)
     tagged_t streamname;
     int socket;
{
...
bool_t prolog_connect_to_socket_type(Arg)
     Argdecl;
{
...
bool_t prolog_socket_accept(Arg)
     Argdecl;
{
...
static tagged_t stream_list(Arg, max_fd, ready_set)
     Argdecl;
     int max_fd;
     fd_set *ready_set;
{
  CIAO_REGISTER int this_fd;
  CIAO_REGISTER tagged_t list = atom_nil;
  CIAO_REGISTER stream_node_t *temp_stream;
...
bool_t prolog_select_socket(Arg)
     Argdecl;
{
...
bool_t prolog_socket_receive(Arg)
     Argdecl;
{
...
bool_t prolog_socket_shutdown(Arg)
     Argdecl;
{
...
/*
bool_t prolog_socket_buffering(Arg)
     Argdecl;
{
...
bool_t prolog_hostname_address(Arg)
     Argdecl;
{
