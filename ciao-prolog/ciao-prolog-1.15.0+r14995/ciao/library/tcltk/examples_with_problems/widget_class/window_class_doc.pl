...
:- doc(title, "The Tcl/Tk Widget Class Interface").
...
:- doc(module,"The @lib{canvas_class} permits create a widget class using
        tcltk library. The constructor class is window_class. ").

:- regtype wiget(W) # "@var{W} is a reference to one type of the items
        widgets.".

:- doc(widget/1,"Each item type is characterized by two things: 
