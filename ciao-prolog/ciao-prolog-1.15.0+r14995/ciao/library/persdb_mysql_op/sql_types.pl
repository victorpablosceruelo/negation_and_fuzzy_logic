...
:- doc(title,"SQL 92 Standard Type System").

:- doc(author,"Manuel Hermenegildo").
:- doc(author,"Manuel Carro").
:- doc(author,"Jes@'{u}s Correas").

:- doc(module,"This module provides Prolog representation and
   checking capabilities for the SQL 92 basic type system.").

:- doc(bug,"There must be a way to describe the database specific
...
:- doc(bug,"There is no type compatibility for date/time types
