:- module(quit,[main/0,test/0],[objects]).
...
test :-
	...
	menu_entry_class(me1):set_action('exit_tk_event_loop(quit:presentation)'),

	menu_entry_class(me2):set_name(Y),
	menu_entry_class(me2):set_label('Quit'),
	menu_entry_class(me2):set_action('exit_tk_event_loop(quit:quit)'),
...
presentation :- 
	...
	button_class(b1):set_action('quit:factorial'),
...
%	entry_class(e1):set_pady('8'),
	...
	button_class(b2):set_action('exit_tk_event_loop(quit:quit)'),
...
quit :- 
	...
	button_class(b3):set_action('exit_tk_event_loop'),
	...
	button_class(b4):set_action('exit_tk_event_loop(quit:cancel)'),
