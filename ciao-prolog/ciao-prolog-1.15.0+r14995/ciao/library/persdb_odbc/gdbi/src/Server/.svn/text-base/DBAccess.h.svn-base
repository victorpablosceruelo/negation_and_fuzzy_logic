...
public:
	...
	bool_t Connect(LPCSTR DSN = NULL, LPCSTR User = NULL, LPCSTR Password = NULL);
	void Disconnect();
	bool_t TryOpenRecordset(CRecordset &rs, LPCSTR sql = NULL, bool_t bReadOnly = TRUE);
	bool_t TryExecuteSQLStatement(LPCTSTR sql);
