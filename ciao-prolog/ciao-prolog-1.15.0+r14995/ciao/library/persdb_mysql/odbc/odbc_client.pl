...
:- doc(module,"This library provides a socket-based interface to
   ...
   ODBC interface developed by C. Taboch and Ignacio Caballero. The interface
   ...
   @bf{Example:} 
@begin{verbatim}
@includeverbatim{../persdb_odbc/examples/db_client_example.pl}
@end{verbatim}
").
...
:- use_module(library(odbc(string2term)), [string2term/2]).
