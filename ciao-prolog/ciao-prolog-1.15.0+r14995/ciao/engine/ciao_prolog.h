...
/* PREcondition_t: ciao_is_integer_s(state, term) */
int ciao_to_integer_s(ciao_state state, 
                      ciao_term  term); 
/* PREcondition_t: ciao_is_integer(term) */
...
ciao_bool ciao_is_float(ciao_term term);
 ...
 /* PREcondition_t: ciao_is_number_s(state, term) */
double ciao_to_float_s(ciao_state state, 
                       ciao_term  term);
/* PREcondition_t: ciao_is_number(term) */
...
/* PREcondition_t: number_string must represent a syntactically valid number */
