...
parse_args(['-v'|Args], ApplName, Options) :-
...
current_default_config_file(A) :-
	valid_dir(ValidDir),
	atom_concat(ValidDir, '_*.pl', ValidPattern),
	ls(ValidDir, ValidPattern, A0),
	A0 \== [],
	!,
	findall(L,
	    (
...
:- doc(bug, "Rename or add a default directory makedir/Makedir,
	instead of installer directory, as recommended by Manuel
	Herme. -- EMM").
