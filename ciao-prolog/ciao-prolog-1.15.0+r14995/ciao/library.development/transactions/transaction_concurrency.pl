...
:- doc(subtitle, "Providing Support for Strict Two-Phase Locking with Deadlock Avoidance").
:- doc(author,"Nick D. Pattengale").
...
:- doc(doinclude,lock_table/3).
:- doc(doinclude,waitfor_arc/3).
:- doc(doinclude,lock/1).
