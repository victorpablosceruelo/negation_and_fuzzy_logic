...
%% 
%% %----------------------------------------------------------------------------
%% :- doc(title,"CIAO syntax support for Prolog systems (e.g., SICStus").
%% %----------------------------------------------------------------------------
%% 
%% :- doc(module,"This module provides suitable definitions for
%%    loading CIAO files under Prolog Systems.").
%% 
%% :- doc(bug,"This is very incomplete. It needs to be unified with
%%    the file used in the CIAO-2.3 compiler.").
%% 
%% :- doc(version(0*5#0,1997/9/12), "Separated engine/compiler 
