...
aspFileName('/home/pippo2/NEWCIAO/CiaoDE/ciao/contrib/asp/examples/ex3/asp2.lp').
...
children([prolog('p3','p3')]).
:- use_module('/home/pippo2/NEWCIAO/CiaoDE/ciao/contrib/asp/examples/ex3/p3.pl').
parent(['asp1lp.asp']).
comma(44).
period(46).
