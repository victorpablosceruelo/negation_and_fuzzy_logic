...
seq(L,X) :- qsortdl_seq([5500|L],X).
par(L,X) :- gc(GC), size(N), N1 is N + 1,
	qsortdl_par_gc([5500|L],N1,GC,X).
par_nondet(L,X) :- gc(GC), size(N), N1 is N + 1,
	qsortdl_par_nondet_gc([5500|L],N1,GC,X).
