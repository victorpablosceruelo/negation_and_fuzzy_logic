...
'GSL library does not seem to be installed. Using dummy
(non-functional) version instead. If you would like to use the
math library and related libraries such as the cost analysis
