...
:- doc(title,"Interface to CV3D").

:- doc(module,"This library provides the @concept{user interface} of
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- doc(doinclude,give_var_names/5).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- doc(doinclude,give_var_names/4).
