...
:- doc(title,"Miscellaneous predicates (@tt{misc})").

:- doc(module,"This module provides different utility predicates for
...
%:- doc(doinclude,retrieve_coord/1).
...
do_constraint(State,Res):-
	...
	name(String,Res),
	mktemp_in_tmp('traceXXXXXX',File),
	open(File,write,St),
...
:- doc(doinclude,valid_constraint/1).
...
%:- doc(doinclude,get_constraint/7).
...
%:- doc(doinclude,definite_variables/1).
...
:- doc(doinclude,is_definite_variables/2).
