...
:- doc(module,"The predicates exported by this module display data in a
...
:- doc(tablewidget3(Title,Header,ElementTable,Footer),"Shows a regular
...
:- pred tablewidget3(+title,+header,+table,+footer,+image).

:- doc(tablewidget3(Title,Header,ElementTable,Footer,BackgroundImage),
