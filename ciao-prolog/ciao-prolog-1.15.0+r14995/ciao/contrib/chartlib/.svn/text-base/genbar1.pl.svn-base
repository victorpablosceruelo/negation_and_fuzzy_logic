:- module(genbar1,[],[assertions,nortchecks,regtypes,isomodes]).
...
:- doc(title,"Barchart widgets - 1").

:- doc(module,"This module defines predicates to show barchart
...
%%:- doc(footer/1,"@var{X} is a text (an atom) describing the footer of
...
:- doc(xbarelement1/1,"@includedef{xbarelement1/1}
...
:- pred yvalues/2 :: yelement * term # "yvalues must be numeric.".
yvalues(YVector,Interp):-
...
:- doc(axis_limit/1,"@includedef{axis_limit/1}
