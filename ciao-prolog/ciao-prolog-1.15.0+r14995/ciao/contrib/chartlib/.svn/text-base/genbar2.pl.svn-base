...
:- doc(barchart2(Header,BarchartTitle,XTitle,XVector,YTitle,YVector,
        Footer),
...
:- pred drawbars(XVector, YVector, Interp).
...
:- doc(xbarelement2/1,"@includedef{xbarelement2/1} Defines the
