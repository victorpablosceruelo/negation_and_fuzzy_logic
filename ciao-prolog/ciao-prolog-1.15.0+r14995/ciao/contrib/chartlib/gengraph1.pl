...
:- doc(title,"Depic line graph").

:- doc(module,"This module defines predicates which depict line graph
...
:- pred connect_lines(Smooth, Interp) :: smooth(Smooth).
...
:- doc(symbol(Symbol)," @includedef{symbol/1} @var{Symbol} stands for
	the shape of the points whether in scatter graphs or in line
	graphs.

").  

:- doc(doinclude,size/1).
...
:- doc(size(Size)," @includedef{size/1} @var{Size} stands for the size in
	pixels of the points whether in scatter graphs or in line graphs.

").
:- doc(doinclude,attributes/1).
...
:- doc(attributes/1,"@includedef{attributes/1}
...
:- doc(vector/1,"@includedef{vector/1} The type vector defines a list
...
:- doc(smooth(Smooth)," @includedef{smooth/1}
