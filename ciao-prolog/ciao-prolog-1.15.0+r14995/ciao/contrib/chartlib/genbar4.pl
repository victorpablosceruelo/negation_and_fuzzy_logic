...
:- doc(title, "Depict barchart widgets - 4").
...
:- doc(barchart4(Header,BarchartTitle,XTitle,XVector,YTitle,
	YVector,Footer),
...
:- doc(percentbarchart4(Header,BTitle,XTitle,XVector,YTitle,
	YVector,Footer), 
...
:- doc(xbarelement4/1,"Defines the attributes of the bar.
   @begin{description}
