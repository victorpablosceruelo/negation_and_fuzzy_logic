...
:- module(transactionstr, [data_decl_expander_tr/2,
	data_goal_expander_tr/4,
	asserta_expander_tr/4,
	assertz_expander_tr/4,
	retract_expander_tr/4,
	%%retractall_expander_tr/4,
	txn_decl_expander_tr/2,
...
%can be expanded
:- data(transaction/1).
txn_decl_expander_tr(0,_) :- retractall_fact(transaction(_/_)).
txn_decl_expander_tr( (:- transactional(F/A)), 
