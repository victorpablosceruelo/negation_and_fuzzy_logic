...
:- doc(usage, "The Ciao profiler is used by including
   @tt{profiler} in the package inclusion list of a module, or by
   means of an explicit @tt{:- use_package(profiler).} directive.").
...
:- doc(summary, "The profiler module provides predicates and
   ...
   options. For more information, see the @tt{./ciaosetup configure
   --help} option of the installer.").
