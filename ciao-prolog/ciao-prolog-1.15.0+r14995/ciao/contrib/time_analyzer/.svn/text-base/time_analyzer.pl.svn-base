...
# "It is the generalization of execute predicate @pred{benchmark/6} with several
  ...
  file. @var{GeneralOptions} are aplied to the plot".
...
# "It is the generalization of execute predicate @pred{benchmark2/6} with several
