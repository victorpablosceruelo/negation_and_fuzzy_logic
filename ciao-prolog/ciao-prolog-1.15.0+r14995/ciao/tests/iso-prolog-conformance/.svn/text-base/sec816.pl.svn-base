...
test_atom_length_errors :-
	error_test(atom_length(_X, 4), instantiation_error),
...
test_atom_concat :-
	test_val(atom_concat('hello', ' world', S), S, 'hello world'),
        ...
        test_true(atom_concat(_P, _Q, 'hello world')).
...
test_atom_concat_errors :-
	error_test(atom_concat(hello, _V1, _V2), instantiation_error).
...
test_sub_atom_errors :-
	error_test(sub_atom(_A, _B, _C, _D, _E), instantiation_error),
        error_test(sub_atom(abracadabra, -1, 3, 2, _S), 
...
test_atom_chars_errors :-
	error_test(atom_chars(_X, _Y), instantiation_error).
...
test_atom_codes_errors :-
	error_test(atom_codes(_X, _Y), instantiation_error).
...
test_char_code :-
        test_true(char_code('a', _Code)),
        test_true(char_code(_B, 77)).
...
test_char_code_errors :-
	error_test(char_code(_X, _Y), instantiation_error),
        error_test(char_code('ab', _Y), type_error(character, 'ab')),
        error_test(char_code(_Char, 9999), representation_error(character_code)).
...
test_number_chars :-
	test_val(number_chars(33, L), L, ['3', '3']),
        ...
        test_true(number_chars(3.14159, _Pi)),
...
test_number_chars_errors :-
	error_test(number_chars(_X, _Y), instantiation_error),
        error_test(number_chars(ab, _Y), type_error(number, ab)),
        error_test(number_chars(_Z, notlist), type_error(list, notlist)).
...
test_number_codes :-
	test_val(number_codes(33, L), L, [0'3, 0'3]),
        ...
        test_true(number_codes(3.14159, _Pi)),
...
test_number_codes_errors :-
	error_test(number_codes(_X, _Y), instantiation_error),
        error_test(number_codes(ab, _Y), type_error(number, ab)),
        error_test(number_codes(_Z, notlist), type_error(list, notlist)).
