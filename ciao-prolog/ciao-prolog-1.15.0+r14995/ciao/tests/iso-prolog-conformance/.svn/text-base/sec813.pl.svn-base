...
test_get_put_byte_errors :-
	error_test(get_byte(_X,_B1), instantiation_error),
        error_test(get_char(fred, _B2), existence_error(stream, fred)),
        error_test(get_char(nostream/noalias, _B3), 
        ...
        error_test(get_byte(outputstream, _Y), permission_error(input, stream, outputstream)),
        close(S1), close(S2).
...
test_peek_byte_errors :-
	error_test(peek_byte(X,_B1), instantiation_error),
        error_test(peek_byte(fred, _B2), existence_error(stream, fred)),
        error_test(peek_byte(nostream/noalias, _Char3), 
                     domain_error(stream_or_alias,nostream/noalias)),
