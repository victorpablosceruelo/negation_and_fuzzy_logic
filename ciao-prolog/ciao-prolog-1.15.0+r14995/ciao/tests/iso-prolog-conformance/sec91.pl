...
test_91:-
	...
	test_val(X1 is +(7,35),X1,42),
     	...
     	error_test(_X4 is +(77,N),instantiation_error),
     	error_test(_X5 is +(foo,77),type_error(evaluable,_)),
     	test_val(X6 is -(7),X6,-7),
     	test_val(X7 is -(3-11),X7,8),
     	test_val(X8 is -(3.2-11),X8,7.8000),
     	error_test(_X9 is -(N),instantiation_error),
     	error_test(_X10 is -(foo),type_error(evaluable, _)),
     	test_val(X11 is -(7,35),X11,-28),
     	test_val(X12 is -(20,3+11),X12,6),
     	test_val(X13 is -(0,3.2+11),X13,-14.2000),
     	error_test(_X14 is -(77,N),instantiation_error),
     	error_test(_X15 is -(foo,77),type_error(evaluable, _)),
	...
	test_val(X16 is *(7,35),X16,245),
     	...
     	error_test(_X19 is *(77,N),instantiation_error),
     	error_test(_X20 is *(foo,77),type_error(evaluable,_)),
     	...
     	error_test(_X27 is /(77,N),instantiation_error),
     	error_test(_X28 is /(foo,77),type_error(evaluable, _)),
     	error_test(_X29 is /(3,0),evaluation_error(_)),
        ...
        log_nl,
     	...
     	error_test(_Y2 is mod(77,N),instantiation_error),
     	error_test(_Y3 is mod(foo,77),type_error(evaluable, _)),
     	error_test(_Y4 is mod(7.5,2),type_error(integer, _)),
     	error_test(_Y5 is mod(7,0),evaluation_error(_)),
     	...
     	error_test(_X38 is round(N),instantiation_error),
     	test_val(X39 is ceiling(-0.5),X39,0),
     	test_val(X40 is truncate(-0.5),X40,0),
     	error_test(_X41 is truncate(foo),type_error(evaluable, _)),
     	test_val(X42 is float(7),X42,7.0),
     	test_val(X43 is float(7.3),X43,7.3),
     	test_val(X44 is float(5/3),X44,1.6666666666666666),
     	error_test(_X45 is float(N),instantiation_error),
     	error_test(_X46 is float(foo),type_error(evaluable, _)),
     	test_val(X47 is abs(7),X47,7),
     	test_val(X48 is abs(3-11),X48,8),
     	test_val(X49 is abs(3.2-11.0),X49,7.8000),
     	error_test(_X50 is abs(N),instantiation_error),
     	error_test(_X51 is abs(foo),type_error(evaluable, _)),
