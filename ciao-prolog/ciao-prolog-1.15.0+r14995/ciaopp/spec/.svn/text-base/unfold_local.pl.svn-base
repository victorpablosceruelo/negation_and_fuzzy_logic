...
:-
  comment(jump_over_builtin(Body,NewBody,Susp,RevSusp,AS,Emb,_Pop),"Predicate
...
:-
  comment(safe_jump_builtin(Body,Sg,Info,NewBody,Susp,RevSusp,AS,Emb,_Pop),"Predicate
...
:-
  comment(bind_ins_jump_builtin(Body,Sg,Info,NewBody,Susp,RevSusp,AS,Emb,_Pop),"Predicate
...
:-
  comment(no_side_effects_jump_builtin(Body,Sg,Info,NewBody,Susp,RevSusp,AS,Emb,_Pop),"Predicate
