...
%:- use_module(library(compiler(srcdbg))).                                      % it uses c_itf_internal
%:- use_module(library(compiler(c_itf))).                                       % it uses c_itf_internal
%:- use_module(library(compiler(c_itf_internal))).                              % it uses build_foreign_interface
...
%pp%%:- use_module(library(classic)).
%:- use_module(library(miscprops)).
:- use_module(library(llists)).
:- use_module(library(ttyout)).
%pp%%:- use_module(library(classic_doc)).
...
%pp%%:- use_module(library(classic_common)).
...
%pp%%:- use_module(library(classic_shell)).
