...
% :- trust pred intended_effort(A,B,C,D,E) => ground([A,B,C,D,E]).
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- doc(title, "Managing European Research Projects"). 
:- doc(subtitle, "Regarding Effort Distribution"). 

:- doc(summary, "This program contains a collection of predicates
which can be used for project management.").

:- doc(responsible, german).

%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
:- doc(effort(+SM,+SY,+EM,+EY,+Unit,-Effort), "Computes in
