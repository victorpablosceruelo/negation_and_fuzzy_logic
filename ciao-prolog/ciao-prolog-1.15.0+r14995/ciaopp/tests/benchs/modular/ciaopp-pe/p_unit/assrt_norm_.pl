...
:- use_module(assrt_db_, [assertion_of/9, assertion_body/7]).
...
:- doc(version(1*0+779,2004/10/21,21:20*33+'CEST'), "Solved a bug
   when normalizing calls assertions bodies contaning ';'.  (David
   Trallero Mena)").

:- doc(version(1*0+270,2004/01/30,18:36*07+'CET'), "Assertion
   heads now accept terms. Declarative properties must go with ? mode.
   (Francisco Bueno Carrillo)").

:- doc(version(1*0+166,2003/12/24,16:59*19+'CET'), "Solved bug 3.
   (Francisco Bueno Carrillo)").

:- doc(version(1*0+163,2003/12/23,20:45*40+'CET'), "Solved bug 4.
   (Francisco Bueno Carrillo)").
