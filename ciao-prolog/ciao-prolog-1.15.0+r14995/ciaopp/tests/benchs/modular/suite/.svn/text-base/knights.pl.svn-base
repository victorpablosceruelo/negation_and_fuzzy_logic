 ...
 %% Last Modified On: Tue May  9 11:44:56 2000
 %% Update Count    : 295
...
knights(N, Board):-
        ...
        !,
        wtime(T),
        write('Total time is: '), write(T), write(' msecs.'), nl.
knights(_N, _Board):-        %% Failed!
        wtime(T),
        write('Total time until failure is: '),
        write(T), write(' msecs.'), nl,
        fail.
