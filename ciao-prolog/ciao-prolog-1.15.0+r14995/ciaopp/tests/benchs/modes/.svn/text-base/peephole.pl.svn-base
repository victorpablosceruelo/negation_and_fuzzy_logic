...
popt1([Inst|Rest], Pil1) :- \+(popt11(Inst,Rest,Pil)), Pil1 = [Inst|Pil], popt1(Rest,Pil).
...
popt1a([Inst|PilRest], Pil1) :- \+(popt1a1(Inst, PilRest, Pil1)), Pil1 = [Inst|Pil1Rest],
...
popt2([Inst|PilRest], Pil1) :- \+(popt21(Inst, PilRest, Pil1)), Pil1 = [Inst|Pil1Rest],
