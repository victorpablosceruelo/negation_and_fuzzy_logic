...
public class Files {
  ...
  /**
   * true
   *   if (types([ret/[void],this/[examples.Files]]))  {
   *        types([ret/[void],this/[examples.Files]])
   *   }   * true
   ...
   *   }
   *  && cost(ub,DATA_STORED,5$1*3$1+5$1*2$1+3$1+2$1),cost(ub,OPENED_FILES,2*5$1+2),cost(ub,CLOSED_FILES,5$1+1)
   */
  ...
  /**
   * true
   *   if (types([ret/[void],this/[examples.Files],arg(1)/[int],arg(2)/[java.lang.String]]))  {
   *        types([ret/[void],this/[examples.Files],arg(1)/[int],arg(2)/[java.lang.String]])
   *   }   * true
   ...
   *   }
   *  && cost(ub,DATA_STORED,3$1*int(arg(1))+3$1+2$1*int(arg(1))+2$1),cost(ub,OPENED_FILES,2*int(arg(1))+2),cost(ub,CLOSED_FILES,int(arg(1))+1)
   */
  ...
  /**
   * true
   *   if (types([ret/[annot_java.lang.StringBuffer],this/[examples.Files],arg(1)/[java.lang.String]]))  {
   *        types([ret/[annot_java.lang.StringBuffer],this/[examples.Files],arg(1)/[java.lang.String]])
   *   }   * true
   *   if (any([ret,this,arg(1)]))  {
   *        any([this,arg(1)])
   *   }   * true
   *   if (arg(1)/top && this/top && ret/top)  {
   *        arg(1)/top && this/top && ret/top && size(ub,ret,3$1+2$1) && size(ub,this,size(this)) && size(ub,arg(1),size(arg(1)))
   *   }
   *  && cost(ub,DATA_STORED,0),cost(ub,OPENED_FILES,1),cost(ub,CLOSED_FILES,0)
   */
    //    try {
...
//     return null;
  ...
  /**
   * true
   *   if (types([ret/[annot_java.lang.StringBuffer],this/[examples.Files],arg(1)/[annot_java.io.DataInputStream]]))  {
   *        types([ret/[annot_java.lang.StringBuffer],this/[examples.Files],arg(1)/[annot_java.io.DataInputStream]])
   *   }   * true
   *   if (any([ret,this,arg(1)]))  {
   *        any([ret,this,arg(1)])
   *   }   * true
   ...
   *   }
   *  && cost(ub,DATA_STORED,0),cost(ub,OPENED_FILES,0),cost(ub,CLOSED_FILES,0)
   */
  ...
  /**
   * true
   *   if (types([ret/[void],this/[examples.Files],arg(1)/[java.lang.String],arg(2)/[annot_java.lang.StringBuffer]]))  {
   *        types([ret/[void],this/[examples.Files],arg(1)/[java.lang.String],arg(2)/[annot_java.lang.StringBuffer]])
   *   }   * true
   ...
   *   }
   *  && cost(ub,DATA_STORED,size(arg(2))),cost(ub,OPENED_FILES,1),cost(ub,CLOSED_FILES,1)
   */
    DataOutputStream p;
