:- module(_1,[hanoi/5],[assertions,regtypes,ciaopp(tests(resources)),predefres(sta_exectime),predefres(res_exectime_me),predefres(res_wamcount),nativeprops,basicmodes]).
...
:- true pred append(_1,L,_2)
         : ( list(_1,^(mv('hanoi_1:elem','hanoi_1:elem'))), rt16(L), term(_2) )
        => ( list(_1,^(mv('hanoi_1:elem','hanoi_1:elem'))), rt16(L), rt16(_2) ).
...
:- true pred append(_1,L,_2)
         : ( list(_1,^(mv('hanoi_1:elem','hanoi_1:elem'))), rt16(L), var(_2) )
        => ( list(_1,^(mv('hanoi_1:elem','hanoi_1:elem'))), rt16(L), rt16(_2) )
         + ( not_fails, covered ).

:- true pred append(_1,L,_2)
         : ( list(_1,^(mv('hanoi_1:elem','hanoi_1:elem'))), rt16(L), var(_2) )
        => ( list(_1,^(mv('hanoi_1:elem','hanoi_1:elem'))), rt16(L), rt16(_2), size(lb,_1,length(_1)), size(lb,L,length(L)), size(lb,_2,length(L)+length(_1)) )
...
:- true pred append(_1,L,_2)
         : ( list(_1,^(mv('hanoi_1:elem','hanoi_1:elem'))), rt16(L), var(_2) )
        => ( list(_1,^(mv('hanoi_1:elem','hanoi_1:elem'))), rt16(L), rt16(_2), size(ub,_1,length(_1)), size(ub,L,length(L)), size(ub,_2,length(L)+length(_1)) )
...
rt16([mv(A,B)|C]) :-
        elem(A),
        elem(B),
        list(C,^mv('hanoi_1:elem','hanoi_1:elem')).
