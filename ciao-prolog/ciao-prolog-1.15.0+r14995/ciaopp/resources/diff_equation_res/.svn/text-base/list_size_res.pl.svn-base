...
solve_lsde1(Var, Bn, GIval, Sol) :- Bn \== [], solve_lsde2(Bn, Var, GIval,
	    Sol).
...
mutual_list_solvable1(factor([head(Expr)], _), Var) :- normal_form(
	    Var, Expr).
mutual_list_solvable1(factor([tail(Expr)], _), Var) :- normal_form(
	    Var, Expr).
