...
body_translate_to_internal('aggregates:bagof'(Var, $(A, _, _), List) :_Id,
	    NBody) :- !,
	NBody = 'aggregates:bagof'(Var, A, List).
body_translate_to_internal('aggregates:setof'(Var, $(A, _, _), List) :_Id,
	    NBody) :- !,
	NBody = 'aggregates:setof'(Var, A, List).
body_translate_to_internal('aggregates:findall'(Var, $(A, _, _), List)
	    :_Id, NBody) :- !,
