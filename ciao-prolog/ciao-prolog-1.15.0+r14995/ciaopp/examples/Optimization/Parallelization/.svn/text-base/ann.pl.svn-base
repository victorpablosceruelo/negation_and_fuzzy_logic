%------------------------------------------------------------------
%	Simple Clause Annotator
%       Manuel Hermenegildo, R. Warren, and M. Muthukumar
%------------------------------------------------------------------

:- module(ann,[analyze_all/2],[assertions]).

:- entry analyze_all(X,Y) : ground * var.

%%:- entry(analyze_all(X,Y),[mshare([[X],[Y]]),var([Y]),linear(X)]).
