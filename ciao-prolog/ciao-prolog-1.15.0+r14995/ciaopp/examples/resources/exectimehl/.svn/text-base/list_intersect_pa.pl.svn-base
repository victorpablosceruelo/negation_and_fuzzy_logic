:- module(_1,[intersect/3],[assertions,ciaopp(examples(resources(exectimehl))),nativeprops,basicmodes,regtypes]).
...
:- true pred intersect(_1,_L,L3)
        ...
        => ( list(_1,num), list(_L,num), list(L3,num), size(ub,_1,length(_1)), size(ub,_L,length(_L)), size(ub,L3,length(_1)) )
         + cost(ub,exectime_model4,421.8789561504807*(length(_L)*length(_1))+999.3555288218533*length(_1)+439.427029583319).
