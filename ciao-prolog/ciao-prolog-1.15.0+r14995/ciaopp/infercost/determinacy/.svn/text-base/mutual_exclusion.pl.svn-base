...
:- use_module(infercost(top(utility)), [nonsequence/1, member/2]).
:- use_module(infercost(init(initsystem_basic)), [clause_type/2]).
:- use_module(infercost(size(normalize_)), [substitute/4]).
:- use_module(infercost(csp(constraint)), [arithmetic_op/1]).
...
convert_op('term_compare:=='(E1, E2),Var,'arithmetic:=:='(E1, E2)) :- E1 == Var,!.
convert_op('term_compare:=='(E1, E2),Var,'arithmetic:=:='(E2, E1)) :- E2 == Var,!.
convert_op('term_compare:\\=='(E1, E2),Var,'arithmetic:=\\='(E1, E2)) :- E1 == Var,!.
convert_op('term_compare:\\=='(E1, E2),Var,'arithmetic:=\\='(E2, E1)) :- E2 == Var,!.
...
mutual_exclusive_number('arithmetic:>'(E1,E2),'arithmetic:=:='(E3,E4)) :-
	E1 == E3,
	number(E2),
	number(E4),
	!,
