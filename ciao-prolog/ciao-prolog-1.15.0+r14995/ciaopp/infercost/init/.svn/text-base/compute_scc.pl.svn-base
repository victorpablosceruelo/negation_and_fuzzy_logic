:- module(compute_scc, [strongly_connected_component/2], [assertions]).
...
:- use_module(infercost(top(utility)), [push/3, pop/3]).
:- use_module(infercost(algebraic(arithm_opers)), [max/3]).
