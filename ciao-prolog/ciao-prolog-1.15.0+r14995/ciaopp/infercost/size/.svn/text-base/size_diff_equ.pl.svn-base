...
:- use_module(infercost(diff_equation(first_order)), [solve_fode/5]).
...
:- use_module(infercost(determinacy(mutual_exclusion)), [comparison_op/1]).
:- use_module(infercost(solution(relation)), 
	[
...
%
 ...
 %% 		(find_symbol_field_clause(ST,Pred,Clause),
