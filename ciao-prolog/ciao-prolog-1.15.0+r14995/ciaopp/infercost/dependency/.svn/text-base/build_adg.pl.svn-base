:- module(build_adg, [argument_dependency_graph/7], [assertions]).
...
:- use_module(infercost(dependency(position)), [new_pos/3]).
:- use_module(infercost(dependency(adg)), 
	[
	    insert_adg_entry/3,
	    insert_adg_field/4
	]).
:- use_module(infercost(top(utility)), [compound/1, nonsequence/1]).
