:- module(cslpoly, [csl_poly/4], [assertions]).
...
csf_node_([],[node(Name,D,Nodes)|Rest],node(Name,D,Nodes),NewGraph,0) :-
	gcp_delete(Name,Rest,NewGraph).
csf_node_([node(Name,D,Nodes)|_],Graph,node(Name,D,Nodes),NewGraph,1) :-
