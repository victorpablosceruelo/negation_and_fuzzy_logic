...
call_to_success(SgKey,Call,Proj,Sg,Sv,AbsInt,_ClId,Succ,F,N,Id) :-
	...
	call_to_success_(SgKey,Call,Proj,Sg,Sv,AbsInt,_ClId,Succ,Id).
...
call_to_success_(SgKey,Call,Proj,Sg,Sv,AbsInt,_ClId,Succ,Id):-
	...
	(identical_proj(AbsInt,Sg,Proj,Subg,Proj1) ->
	    true
	;
	    (less_or_equal_proj(AbsInt,Sg,Proj,Subg,Proj1) ->
	        write(widening)
	    ;
		write('wrong!!')
	    )
...
call_to_success_(SgKey,Call,Proj,Sg,Sv,AbsInt,ClId,Succ,Id) :-
...
%% init_fixpoint0(SgKey,Call,Proj0,Sg,Sv,AbsInt,ClId,Id,Prime):-
%% 	current_pp_flag(widen,on),
%%	current_pp_flag(multi_success,off),
%% 	widen_call(AbsInt,SgKey,Sg,F,N,Proj0,Proj), !,
%% 	init_fixpoint1(SgKey,Call,Proj,Sg,Sv,AbsInt,ClId,Id,Prime).
%% init_fixpoint0(SgKey,Call,Proj,Sg,Sv,AbsInt,ClId,Id,Prime):-
%% 	init_fixpoint_(SgKey,Call,Proj,Sg,Sv,AbsInt,ClId,Id,Prime).
%% 
%% init_fixpoint1(SgKey,_Call,Proj,Sg,_Sv,AbsInt,_ClId,Id,Prime):-
%% 	current_fact(complete(SgKey,AbsInt,Subg,Proj1,Prime1,Id,_Fs),_Ref),
%% 	identical_proj(AbsInt,Sg,Proj,Subg,Proj1),!,
%% %check3	reuse_complete(Ref,SgKey,Proj,Sg,AbsInt,F,N,Id,Fs,Prime1,Prime),
%% 	each_abs_sort(Prime1,AbsInt,Prime).
...
init_fixpoint_(SgKey,Call,Proj,Sg,Sv,AbsInt,_ClId,Id,Prime):-
...
init_fixpoint_(SgKey,_Call,Proj,Sg,Sv,AbsInt,ClId,Id,LPrime) :-
...
body_succ(Call,Atom,Succ,HvFv_u,AbsInt,ClId,ParentId,Id):- 
	...
	fixpoint_trace('exit goal',_Id,ParentId,(SgKey,Key),Sg,Succ,AbsInt).
