...
:- use_module(plai(domains(termsd)), [precondition_builtin/2, 	postcondition_builtin/4]).
...
:- use_module(program(itf_db), [current_itf/3, preloaded_module/2]).
