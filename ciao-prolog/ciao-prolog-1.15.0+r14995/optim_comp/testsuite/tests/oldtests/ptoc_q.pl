...
:- '$ptoc_prop'('ptoc_q:queens_2'/3, [register=true]).
:- endif.
queens_2([], Qs, Qs).
...
:- '$ptoc_prop'('ptoc_q:no_attack'/2, [imp=semidet, register=true]).
...
%:- '$ptoc_prop'('ptoc_q:sel'/3, []).
%:- '$ptoc_prop'('ptoc_q:sel'/3, [register=true]).
