 ...
 %% Last Modified On: Tue Jun  8 19:10:57 1999
 %% Update Count    : 189
 %% Status          : Completed
...
:- include('../common').
benchmark_data(wumpus, 10, wumpus) :-
	true.
benchmark(wumpus, _Out) :-
	w.
...
dims(mat(DimX, DimY, _), DimX, DimY).
 ...
 %% wt(_File):-
 %%         write('No esta disponible wt/1 en esta version'), nl.
...
lee_otras_filas_(10, _, Filas, Filas, _) :- !. % Linea en blanco
