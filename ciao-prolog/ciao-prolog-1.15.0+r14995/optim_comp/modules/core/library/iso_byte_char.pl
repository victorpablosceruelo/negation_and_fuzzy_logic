...
:- doc(author, "Documentation written by Edison Mera, based on ISO
   Prolog standard. Minor mods by Manuel Hermenegildo.").
...
:- doc(char_code(Char,Code), "Succeeds iif the character code of
...
:- doc(peek_byte(Stream, Byte), "Is true iif @var{Byte} unifies
   with the next byte to be input from the target @var{Stream}.").
