...
:- cnative_include(.(io_alias_redirection)).
...
# "Associate @var{StreamAlias} with an open stream @var{newStream}.
   Returns in @var{OldStream} the stream previusly associated with the
