...
:- doc(author,"First version by Richard A. O'Keefe and David
   H.D. Warren. Changes by Mats Carlsson, Daniel Cabeza, and Manuel
   Hermenegildo").

:- doc(module,"This module implements the standard solution
...
:- pred concordant_subset(list(kvpair), Key, list(Val))
...
:- pred '^'(X,P) # "Existential quantification: @var{X} is existentially
   quantified in @var{P}. E.g., in @tt{A^p(A,B)}, @tt{A} is
