...
:- doc(module, "This chapter documents the @concept{builtin
   directives} in Ciao for extending the syntax of source files.  Note
   that the @concept{ISO-Prolog} directive @decl{char_conversion/2} is not
...
:- doc(doinclude,add_sentence_trans/1).
:- true decl add_sentence_trans(Predicate) : translation_predname
...
:- doc(doinclude,add_term_trans/1).
...
:- doc(doinclude,add_goal_trans/1).
:- true decl add_goal_trans(Predicate) : translation_predname
...
:- doc(doinclude,add_clause_trans/1).
