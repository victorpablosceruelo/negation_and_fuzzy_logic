#if !defined(__CIAO_PROLOG_H__)
#define __CIAO_PROLOG_H__
...
typedef struct goal_descriptor *ciao_state;
...
ciao_term ciao_dlist_a_s(ciao_state state, 
                         ...
                         ciao_term *args, 
                         ciao_term  base);
ciao_term ciao_dlist_a(long len, 
                       ciao_term *args, 
                       ciao_term  base);
...
ciao_term ciao_listn_a_s(ciao_state state, 
                         long       len, 
                         ciao_term *args);
ciao_term ciao_listn_a(long       len,
                       ciao_term *args);
...
long ciao_to_integer_s(ciao_state state, 
                       ciao_term  term); 
...
long ciao_structure_arity_s(ciao_state state, 
                            ciao_term  term);
...
ciao_bool ciao_is_char_code_list(ciao_state state, 
                                 ciao_term  term);
long ciao_is_int_list(ciao_state state, 
                     ciao_term  term);
long ciao_list_length(ciao_state state, 
                     ciao_term  term);
char *ciao_list_to_byte_array(ciao_state state, 
                              ciao_term  list);
long *ciao_list_to_int_array(ciao_state state, 
                             ciao_term  list);
