...
myclassconstructor(Cons,ID,From,MetaCall) :-
	'class$constructor'(Cons,Module),
	method_head(Cons,ID,ConsImpl),
	last_module_exp(Module:ConsImpl,goal,From,Module,MetaCall).
