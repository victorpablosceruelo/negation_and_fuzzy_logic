\subsubsection{Reconstruct predicate tree with equivalence}
\label{sec:ReConstruct}
In this section, we present the approach of constructing predicate tree with equivalence, which is used to expand two comparing nodes with same structure in the algorithm introduced in section \ref{sec:Algorithm}.
...
\begin{ex}
Continue example \ref{ConstructPredicateTree}, reconstruct predicate trees with equivalence.
