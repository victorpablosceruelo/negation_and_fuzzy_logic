...
\newcommand{\eachPageMsg}{EMCL Thesis: WTF.}
...
% \preptocmd{\thebibliography}{\cleardoublepage \fancyhead[C]{\bibname}}{}{}
% \preptocmd{\appendix}{\cleardoublepage \fancyhead[C]{\appendixname\ \thechapter}}{}{}
...
\pagestyle{empty}
\input{newContent/Acknowledgements}
\clearemptydoublepage
...
% Odd (impar)
\fancyhead[OL]{\slshape APPENDIX}
\fancyhead[OR]{}
% Even (par)
\fancyhead[EL]{}
\fancyhead[ER]{\slshape APPENDIX}
