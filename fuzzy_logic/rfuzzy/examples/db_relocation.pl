...
% TYPE DECLARATION
rfuzzy_define_database(house/12, 
...
% DATABASE
house(lfs2168,'apartment',          114,    5, 2,     3,   4, 1,      630000,      200,   5700, 1000).
house(lfs2144,'apartment',            77,    3, 1,     3, 11, 2,      420000,      700,   3500, 1500).
house(lfs2147,'apartment',            80,    2, 1,     2, 11, 3,      675000,    1200,     200,   500).
house(lfs2145,'apartment',          224,    8, 3,     4,   4, 0,      790000,    2000,     100, 2000).
house(c358,'apartment',                74,    3, 1,     3,   4, 0,      340000,      500,   3100, 1000).
house(lfs2110,'apartment',          155,    9, 4,     3,   4, 2,    2500000,      800,   2400,   200).
house(lfs2124,'apartment',            63,    2, 1,     4,   4, 0,      275000,    1500,     450,   100).
house(lfs2123,'apartment',            62,    3, 1,     1,   1, 0,      285000,    6000,   1000,   300).
house(lfs2155,'villa',                  2300,    9, 4, null,   3, 1,    3000000,  13000,     800,  2000).
house(lfs2111,'villa',                    700,  10, 5, null,   3, 1,    1100000,    9000,   4500,  3000).
house(lfs2047,'villa',                  1750,  11, 5, null,   1, 0,    1650000,  15000,   1000,  5000).
house(lfs2041,'villa',                  4000,  13, 7, null,   2, 0,    2500000,    4000,   1800,  4000).
house(es13462,'villa',                  600,    6, 2, null,   2, 0,    4000000,    6000,   1500,  2000).
house(lfs1942,'villa',                    900,  10, 4, null,   2, 0,    3100000,    3000,   3400,  6000).
house(lfs1917,'villa',                    210,    5, 2, null,   3, 0,      590000,  13000,   5000,  7000).
house(lfb143,'villa',                    1200,    9, 3, null,   1, 0,    2750000,    7000,   4000,  1000).
house(5607/152,'town_house',    161,    7, 4, null,   3, 1,      815000,    6000,   1200,    300).
house(es13340,'town_house',   1025,    8, 4, null,   1, 0,    2800000,  25000,   7000,    500).
house(lfs1939,'town_house',       860,    9, 5, null,   2, 0,    1800000,  14000,   2400,  1000).
house(lfs1938,'town_house',       520,  11, 6, null,   2, 0,    1990000,  19000,       80,  3000).
