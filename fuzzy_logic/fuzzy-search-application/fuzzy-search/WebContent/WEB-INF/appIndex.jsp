    ...
    <div id="main">        
        <div id="text" >
			<center>
				...
				<img src="facebook.jpeg"	alt="Facebook" title="Facebook" border="0"></img>
				</a> <br /> <br />
				...
				<img src="https://secure.shared.live.com/~Live.SiteContent.Explore/~15.40.70/header/logo_mai.png"
					alt="HotMail" title="HotMail" border="0"></img></a> 
					<br /> <br /> 
				
				<a href="SocialAuthServlet?id=linkedin&mode=signin">
				<img src="http://press.linkedin.com/sites/all/themes/presslinkedin/images/follow_linkedin.gif"
					alt="Linked In" title="Linked In" border="0"></img></a> 
					<br /> <br />
				
				<br /> <a href="SocialAuthServlet?id=foursquare&mode=signin">
				<img src="images/foursquare.jpeg" alt="FourSquare" title="FourSquare"
					border="0"></img></a> 
					<br /> <br />
