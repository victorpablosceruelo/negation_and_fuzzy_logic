 ...
 * $Revision: 1.9.2.2 $
 * $Date: 2005-01-31 19:46:15 +0100 (Mon, 31 Jan 2005) $
 * ====================================================================
 *
 ...
 * @author Ortwin Glück
 * @author Jeff Dever
 * @version $Id: TestMethodsExternalHost.java 149282 2005-01-31 18:46:15Z oglueck $
 */
    ...
    public void setUp() {
        ...
        if (PROXY_HOST != null) {
            if (PROXY_USER != null) {
                ...
                state.setProxyCredentials(null, PROXY_HOST, new UsernamePasswordCredentials(
