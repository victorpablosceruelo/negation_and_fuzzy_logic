/*
 * $Header: /home/jerenkrantz/tmp/commons/commons-convert/cvs/home/cvs/jakarta-commons//httpclient/src/test/org/apache/commons/httpclient/Attic/SimpleHttpConnection.java,v 1.18 2004/02/22 18:08:49 olegk Exp $
 * $Revision: 1.18 $
...
class SimpleHttpConnection extends HttpConnection {
    ...
    public void open() throws IOException {
        ...
        try{
            ...
            byte[] bodyContent = EncodingUtil.getBytes((String)bodies.elementAt(hits), "ISO-8859-1");
    ...
    throws IOException, IllegalStateException {
        String str = HttpParser.readLine(inputStream, charset);
        log.debug("read: " + str);
        return str;
    }
