...
:- comment(author, "Santiago D@'{i}ez P@'{e}rez").

:- comment(summary, "This package provides basic functionality to 
...
:- comment(bug, "There is a problem with the code transformation and
the assertions package; end_of_file is not transformed correctly.").

:- comment(usage, "The recommended procedure in order to enable 
...
:- comment(module, "This library provides the functionality needed to
